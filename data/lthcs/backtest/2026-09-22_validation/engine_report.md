...
Window: **2026-02-17 -> 2026-09-21** (150 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.3424 |
| Annualized Sharpe | +1.558 (95% CI: -0.81 ... +4.17) |
| Annualized Sortino | +1.027 (95% CI: -0.52 ... +3.22) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.313 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1051 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1416**

## Run metadata

```json
{
  "band_hash": "136a3adf7880080c",
