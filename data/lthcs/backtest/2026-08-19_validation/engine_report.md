...
Window: **2026-02-17 -> 2026-08-19** (128 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.4127 |
| Annualized Sharpe | +1.687 (95% CI: -0.75 ... +4.76) |
| Annualized Sortino | +1.203 (95% CI: -0.51 ... +4.06) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.367 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1231 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1322**

## Run metadata

```json
{
  "band_hash": "78f0adadbe2fa42e",
