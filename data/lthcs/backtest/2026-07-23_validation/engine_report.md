...
Window: **2026-02-17 -> 2026-07-23** (109 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.5012 |
| Annualized Sharpe | +1.828 (95% CI: -0.82 ... +4.73) |
| Annualized Sortino | +1.413 (95% CI: -0.68 ... +4.15) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.431 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1446 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.0868**

## Run metadata

```json
{
  "band_hash": "9830c56c8b24a5a8",
