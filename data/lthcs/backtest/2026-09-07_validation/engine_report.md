...
Window: **2026-02-17 -> 2026-09-04** (140 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.3712 |
| Annualized Sharpe | +1.612 (95% CI: -0.83 ... +4.38) |
| Annualized Sortino | +1.100 (95% CI: -0.56 ... +3.45) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.336 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1126 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1339**

## Run metadata

```json
{
  "band_hash": "1e747463cb716bf4",
