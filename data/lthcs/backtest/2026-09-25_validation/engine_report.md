...
Window: **2026-02-17 -> 2026-09-24** (153 trading days)
...
| Annualized Sharpe | +1.542 (95% CI: -0.66 ... +4.26) |
| Annualized Sortino | +1.006 (95% CI: -0.43 ... +3.47) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.307 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1030 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1323**

## Run metadata

```json
{
  "band_hash": "b2dc79dd4e4489ad",
