...
Window: **2026-02-17 -> 2026-09-01** (137 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.3807 |
| Annualized Sharpe | +1.630 (95% CI: -0.78 ... +4.37) |
| Annualized Sortino | +1.124 (95% CI: -0.53 ... +3.49) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.343 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1150 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1215**

## Run metadata

```json
{
  "band_hash": "8b503882b2e5625c",
