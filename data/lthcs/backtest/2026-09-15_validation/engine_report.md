...
Window: **2026-02-17 -> 2026-09-14** (145 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.3562 |
| Annualized Sharpe | +1.584 (95% CI: -0.87 ... +4.37) |
| Annualized Sortino | +1.062 (95% CI: -0.53 ... +3.41) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.324 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1087 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1202**

## Run metadata

```json
{
  "band_hash": "29e0e26fb003108f",
