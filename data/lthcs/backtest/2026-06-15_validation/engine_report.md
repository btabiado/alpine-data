...
Window: **2026-02-17 -> 2026-06-12** (82 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.7189 |
| Annualized Sharpe | +2.109 (95% CI: -1.07 ... +5.88) |
| Annualized Sortino | +1.878 (95% CI: -0.92 ... +6.03) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.573 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1922 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.0892**

## Run metadata

```json
{
  "band_hash": "ed8d43cdbd768d24",
