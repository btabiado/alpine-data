...
Window: **2026-02-17 -> 2026-08-17** (126 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.4205 |
| Annualized Sharpe | +1.700 (95% CI: -0.65 ... +4.80) |
| Annualized Sortino | +1.222 (95% CI: -0.46 ... +4.00) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.373 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1251 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1376**

## Run metadata

```json
{
  "band_hash": "9fb46d0e04778ebf",
