...
Window: **2026-02-17 -> 2026-05-26** (69 trading days)
...
|:-------|------:|
| Total return | +0.1832 |
| Annualized return | +0.8652 |
| Annualized Sharpe | +2.524 (95% CI: -1.00 ... +6.34) |
| Annualized Sortino | +2.479 (95% CI: -0.96 ... +6.91) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.594 |
| Avg hold days | 7.6 |
| Avg turnover / day | 0.1997 |
| Total trades | 51 |
| Unique tickers | 20 |
...
Benchmark total return: **+0.1022**

## Run metadata

```json
{
  "band_hash": "9347a83af293b4cd",
