...
Window: **2026-02-17 -> 2026-07-21** (107 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.5127 |
| Annualized Sharpe | +1.845 (95% CI: -0.68 ... +5.12) |
| Annualized Sortino | +1.439 (95% CI: -0.50 ... +4.40) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.439 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1473 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1016**

## Run metadata

```json
{
  "band_hash": "b849f433c7eda941",
