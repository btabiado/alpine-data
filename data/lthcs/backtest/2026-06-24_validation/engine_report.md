...
Window: **2026-02-17 -> 2026-06-24** (89 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.6464 |
| Annualized Sharpe | +2.024 (95% CI: -1.11 ... +5.53) |
| Annualized Sortino | +1.730 (95% CI: -0.92 ... +5.76) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.528 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1771 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.0795**

## Run metadata

```json
{
  "band_hash": "9af8a623db9d7108",
