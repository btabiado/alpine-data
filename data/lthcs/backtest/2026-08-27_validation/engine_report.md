...
Window: **2026-02-17 -> 2026-08-26** (133 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.3943 |
| Annualized Sharpe | +1.654 (95% CI: -0.80 ... +4.69) |
| Annualized Sortino | +1.158 (95% CI: -0.54 ... +3.89) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.353 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1185 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1278**

## Run metadata

```json
{
  "band_hash": "036d577173940a5c",
