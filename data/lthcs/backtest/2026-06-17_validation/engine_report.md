...
Window: **2026-02-17 -> 2026-06-16** (84 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.6966 |
| Annualized Sharpe | +2.084 (95% CI: -1.08 ... +5.88) |
| Annualized Sortino | +1.833 (95% CI: -0.91 ... +5.50) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.560 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1876 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1018**

## Run metadata

```json
{
  "band_hash": "45facd404ab002f8",
