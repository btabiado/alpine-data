...
Window: **2026-02-17 -> 2026-08-24** (131 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.4014 |
| Annualized Sharpe | +1.667 (95% CI: -0.71 ... +4.72) |
| Annualized Sortino | +1.175 (95% CI: -0.49 ... +3.94) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.359 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1203 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1240**

## Run metadata

```json
{
  "band_hash": "c31bb867a359a54f",
