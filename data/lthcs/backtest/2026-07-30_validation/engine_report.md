...
Window: **2026-02-17 -> 2026-07-30** (114 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.4744 |
| Annualized Sharpe | +1.788 (95% CI: -0.71 ... +4.79) |
| Annualized Sortino | +1.351 (95% CI: -0.53 ... +4.33) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.412 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1382 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.0919**

## Run metadata

```json
{
  "band_hash": "25addff5eb38654d",
