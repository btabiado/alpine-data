...
Window: **2026-02-17 -> 2026-08-21** (130 trading days)
...
| Annualized Sharpe | +1.674 (95% CI: -0.80 ... +4.69) |
| Annualized Sortino | +1.184 (95% CI: -0.53 ... +3.93) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.362 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1212 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1273**

## Run metadata

```json
{
  "band_hash": "2f4f376a38c5ab8c",
