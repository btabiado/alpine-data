...
Window: **2026-02-17 -> 2026-08-13** (124 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.4286 |
| Annualized Sharpe | +1.714 (95% CI: -0.84 ... +4.60) |
| Annualized Sortino | +1.242 (95% CI: -0.64 ... +3.99) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.379 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1271 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1452**

## Run metadata

```json
{
  "band_hash": "5a4d9ab97984f731",
