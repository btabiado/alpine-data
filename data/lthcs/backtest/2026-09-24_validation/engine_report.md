...
Window: **2026-02-17 -> 2026-09-23** (152 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.3372 |
| Annualized Sharpe | +1.547 (95% CI: -0.73 ... +4.31) |
| Annualized Sortino | +1.013 (95% CI: -0.47 ... +3.44) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.309 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1037 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1332**

## Run metadata

```json
{
  "band_hash": "8fb05eab260c0d2e",
