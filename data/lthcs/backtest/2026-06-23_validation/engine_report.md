...
Window: **2026-02-17 -> 2026-06-23** (88 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.6559 |
| Annualized Sharpe | +2.036 (95% CI: -1.09 ... +5.95) |
| Annualized Sortino | +1.750 (95% CI: -0.96 ... +5.93) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.534 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1791 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.0800**

## Run metadata

```json
{
  "band_hash": "225cf064193eb97a",
