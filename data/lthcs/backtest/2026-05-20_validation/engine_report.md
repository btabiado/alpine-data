...
Window: **2026-02-17 -> 2026-05-20** (66 trading days)
...
|:-------|------:|
| Total return | +0.1592 |
| Annualized return | +0.7734 |
| Annualized Sharpe | +2.316 (95% CI: -1.44 ... +6.49) |
| Annualized Sortino | +2.253 (95% CI: -1.40 ... +6.82) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.591 |
| Avg hold days | 6.0 |
| Avg turnover / day | 0.1928 |
| Total trades | 49 |
| Unique tickers | 19 |
...
Benchmark total return: **+0.0885**

## Run metadata

```json
{
  "band_hash": "04408d2e825d693e",
