...
Window: **2026-02-17 -> 2026-08-31** (136 trading days)
...
| Annualized Sharpe | +1.636 (95% CI: -0.78 ... +4.52) |
| Annualized Sortino | +1.132 (95% CI: -0.54 ... +3.66) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.346 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1159 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1293**

## Run metadata

```json
{
  "band_hash": "99f620a05883a2ab",
