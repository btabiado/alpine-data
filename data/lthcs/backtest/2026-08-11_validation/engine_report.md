...
Window: **2026-02-17 -> 2026-08-11** (122 trading days)
...
| Annualized Sharpe | +1.728 (95% CI: -0.82 ... +4.77) |
| Annualized Sortino | +1.262 (95% CI: -0.60 ... +4.27) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.385 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1292 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1344**

## Run metadata

```json
{
  "band_hash": "7f891d733804a983",
