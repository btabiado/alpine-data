...
Window: **2026-02-17 -> 2026-08-28** (135 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.3874 |
| Annualized Sharpe | +1.642 (95% CI: -0.74 ... +4.44) |
| Annualized Sortino | +1.141 (95% CI: -0.52 ... +3.57) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.348 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1167 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1327**

## Run metadata

```json
{
  "band_hash": "b2696ae6b4c4ac52",
