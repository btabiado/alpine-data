...
Window: **2026-02-17 -> 2026-07-31** (115 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.4694 |
| Annualized Sharpe | +1.780 (95% CI: -0.81 ... +4.69) |
| Annualized Sortino | +1.339 (95% CI: -0.59 ... +4.18) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.409 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1370 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.0998**

## Run metadata

```json
{
  "band_hash": "cbf39383f61f1729",
