...
Window: **2026-02-17 -> 2026-06-15** (83 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.7076 |
| Annualized Sharpe | +2.096 (95% CI: -1.13 ... +5.79) |
| Annualized Sortino | +1.855 (95% CI: -0.99 ... +5.95) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.566 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1899 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1084**

## Run metadata

```json
{
  "band_hash": "423fa61366671b82",
