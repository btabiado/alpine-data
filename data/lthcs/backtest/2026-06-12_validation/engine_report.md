...
Window: **2026-02-17 -> 2026-06-11** (81 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.7306 |
| Annualized Sharpe | +2.122 (95% CI: -0.97 ... +5.85) |
| Annualized Sortino | +1.901 (95% CI: -0.85 ... +5.90) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.580 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1946 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.0834**

## Run metadata

```json
{
  "band_hash": "2b35265946b58dc5",
