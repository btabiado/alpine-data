...
Window: **2026-02-17 -> 2026-07-07** (97 trading days)
...
|:-------|------:|
| Total return | +0.1898 |
| Annualized return | +0.5780 |
| Annualized Sharpe | +1.935 (95% CI: -0.77 ... +5.40) |
| Annualized Sortino | +1.584 (95% CI: -0.60 ... +4.93) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.485 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1625 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1008**

## Run metadata

```json
{
  "band_hash": "58b756f92c572f70",
