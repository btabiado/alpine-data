...
Window: **2026-02-17 -> 2026-07-27** (111 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.4901 |
| Annualized Sharpe | +1.812 (95% CI: -0.99 ... +4.85) |
| Annualized Sortino | +1.387 (95% CI: -0.71 ... +4.12) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.423 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1420 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.0881**

## Run metadata

```json
{
  "band_hash": "b1670010840dba20",
