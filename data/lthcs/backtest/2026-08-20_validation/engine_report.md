...
Window: **2026-02-17 -> 2026-08-20** (129 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.4089 |
| Annualized Sharpe | +1.680 (95% CI: -0.74 ... +4.83) |
| Annualized Sortino | +1.194 (95% CI: -0.50 ... +4.04) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.364 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1222 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1227**

## Run metadata

```json
{
  "band_hash": "62bd612b5e1fb1ba",
