...
Window: **2026-02-17 -> 2026-07-13** (101 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.5508 |
| Annualized Sharpe | +1.900 (95% CI: -0.73 ... +5.17) |
| Annualized Sortino | +1.525 (95% CI: -0.58 ... +4.61) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.465 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1560 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1030**

## Run metadata

```json
{
  "band_hash": "3ad9cea4edabe65a",
