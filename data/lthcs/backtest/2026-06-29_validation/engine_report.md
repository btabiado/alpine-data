...
Window: **2026-02-17 -> 2026-06-29** (92 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.6196 |
| Annualized Sharpe | +1.991 (95% CI: -0.90 ... +5.41) |
| Annualized Sortino | +1.674 (95% CI: -0.78 ... +5.13) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.511 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1713 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.0909**

## Run metadata

```json
{
  "band_hash": "4a0e24ac26139785",
