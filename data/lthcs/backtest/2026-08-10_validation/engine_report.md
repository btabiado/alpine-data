...
Window: **2026-02-17 -> 2026-08-10** (121 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.4414 |
| Annualized Sharpe | +1.735 (95% CI: -0.76 ... +4.78) |
| Annualized Sortino | +1.273 (95% CI: -0.56 ... +4.17) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.388 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1302 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1381**

## Run metadata

```json
{
  "band_hash": "5a05e1d3c5ef1431",
