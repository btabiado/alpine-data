...
Window: **2026-02-17 -> 2026-06-10** (80 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.7426 |
| Annualized Sharpe | +2.136 (95% CI: -1.15 ... +5.68) |
| Annualized Sortino | +1.925 (95% CI: -1.06 ... +5.79) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.588 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1970 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.0653**

## Run metadata

```json
{
  "band_hash": "d4b1f361954cb68c",
