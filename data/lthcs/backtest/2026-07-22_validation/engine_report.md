...
Window: **2026-02-17 -> 2026-07-22** (108 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.5069 |
| Annualized Sharpe | +1.837 (95% CI: -0.87 ... +4.98) |
| Annualized Sortino | +1.426 (95% CI: -0.66 ... +4.45) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.435 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1459 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1004**

## Run metadata

```json
{
  "band_hash": "c577acb4194405bb",
