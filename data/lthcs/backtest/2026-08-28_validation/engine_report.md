...
Window: **2026-02-17 -> 2026-08-27** (134 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.3908 |
| Annualized Sharpe | +1.648 (95% CI: -0.84 ... +4.56) |
| Annualized Sortino | +1.149 (95% CI: -0.58 ... +3.79) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.351 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1176 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1352**

## Run metadata

```json
{
  "band_hash": "523d69201bc25eec",
