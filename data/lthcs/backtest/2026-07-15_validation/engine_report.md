...
Window: **2026-02-17 -> 2026-07-15** (103 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.5375 |
| Annualized Sharpe | +1.881 (95% CI: -0.80 ... +5.15) |
| Annualized Sortino | +1.495 (95% CI: -0.59 ... +4.54) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.456 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1530 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1113**

## Run metadata

```json
{
  "band_hash": "60cb066206c31c5b",
