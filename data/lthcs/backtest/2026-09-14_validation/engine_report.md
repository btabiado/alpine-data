...
Window: **2026-02-17 -> 2026-09-11** (144 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.3591 |
| Annualized Sharpe | +1.590 (95% CI: -0.82 ... +4.26) |
| Annualized Sortino | +1.069 (95% CI: -0.53 ... +3.40) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.326 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1094 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1252**

## Run metadata

```json
{
  "band_hash": "d9e86f1f6cd8e13c",
