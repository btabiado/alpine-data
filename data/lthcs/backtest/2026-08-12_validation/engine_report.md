...
Window: **2026-02-17 -> 2026-08-12** (123 trading days)
...
|:-------|------:|
| Total return | +0.1902 |
| Annualized return | +0.4328 |
| Annualized Sharpe | +1.721 (95% CI: -0.85 ... +4.58) |
| Annualized Sortino | +1.252 (95% CI: -0.62 ... +3.82) |
| Max drawdown | -0.1058 |
| Hit rate (daily) | 0.382 |
| Avg hold days | 12.6 |
| Avg turnover / day | 0.1281 |
| Total trades | 68 |
| Unique tickers | 28 |
...
Benchmark total return: **+0.1373**

## Run metadata

```json
{
  "band_hash": "e3fbdae72b8bb98b",
